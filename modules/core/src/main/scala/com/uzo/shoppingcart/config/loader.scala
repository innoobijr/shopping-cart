package com.uzo.shoppingcart.config
...
import com.uzo.shoppingcart.config.environments._
import com.uzo.shoppingcart.config.environments.AppEnvironment._

object load {

  // Discerning between two environments
